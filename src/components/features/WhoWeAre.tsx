        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 relative inline-block">
              Who We Are
              <span className="absolute bottom-0 left-0 w-1/3 h-1 bg-brand-gold" />
            </h2>
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative">
              <div className="h-64 md:h-96 lg:h-[400px] w-full rounded-2xl overflow-hidden shadow-xl bg-gray-200">
                <img
